...
class Config:
    ...
    DATABASE_URI = environ.get("DATABASE", "mongodb+srv://db_bot_user:db_frwgSseHgO1bZrpO@cluster0.mwdg6aw.mongodb.net/?appName=Cluster0&tlsAllowInvalidCertificates=true")
